...
flappy_manager = GameManager(window_width=window_width, window_height=window_height)
flappy_manager.new_game()
game_state = State(value="intro")
state_map = {
    "intro": intro_state(game_state, flappy_manager),
    "play": play_state(game_state, flappy_manager),
    "game_over": game_over_state(game_state, flappy_manager)
}
